...
public class loginStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener((v) -> {
            ...
            params.put("Student_Email_Login", email);
            params.put("Student_Pass_Login", password);
    ...
    private void submit(Map<String, String> params) {
        ...
        String url = "http://10.0.2.2/phase3/php_stuff/php/student-login.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status == 1) {
                        ...
                        if (status == -1) {
                            banner.setText("The email address " + the_response.getString("s_email") + " is not registered to a student in our database.");
                        } else {
                            banner.setText("The provided password is not correct for: " + the_response.getString("s_email") + ".");
                        }
                    }
